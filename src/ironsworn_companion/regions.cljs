...
(def all-regions
  {"Barrier Islands" {:features ["Crashing waves and treacherous currents"
   ...
   "Ragged Coast" {:features ["Narrow fjords"
                              ...
                              "Trade ships flying colourful sails"
                   ...
                   :description "This coast is marked by massive fjords. It is a rugged land of snow-capped cliffs overlooking blue waters. Ironlander settlements are located at the head of the fjords in the shelter of narrow valleys. From there, both fisher-folk and raiders set sail. Their kin gather to see them off, laying wreaths of spruce in their wake. In the centre of each settlement, at the front of the longhouse, a stack of rune-marked river stones memorialise those who did not return—one stone for each of the lost."
   ...
   "Shattered Wastes" {:features ["Vast fields of broken ice"
                       ...
                       :starter "The traveller returned from his journey into the Shattered Wastes with dead, frostbitten hands and extraordinary stories. The others scoff at him, but you believe. Why? What does he tell you? What compels you to see for yourself?"}})
